...
namespace CliffGame
{
    public class FMODEvents : MonoBehaviour
    {
        ...
        [field: Header("Monster Bird SFX")]
        [field: SerializeField] public EventReference MonsterBirdWarning { get; private set; }
        [field: SerializeField] public EventReference MonsterBirdHurt { get; private set; }
